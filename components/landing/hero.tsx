    ...
    <section className="relative overflow-hidden pt-28 pb-20 lg:pt-36 lg:pb-32 bg-transparent">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12">
          ...
          <div className="anim-scale-in relative lg:col-span-6 flex items-center justify-center min-h-[500px]" style={{ animationDelay: "0.5s" }}>
            
            {/* Background 3D curves & panels */}
            
            {/* 1. Fluted wooden/slatted wall texture panel */}
            <div className="absolute right-[5%] bottom-[120px] w-[200px] h-[340px] fluted-texture opacity-[0.03] rounded-xl border-l border-white/[0.04] z-0" />
            
            {/* 2. Deep Slate-Grey Curved Panel */}
            <div 
              className="absolute right-[12%] bottom-[120px] w-[280px] h-[390px] rounded-t-[140px] shadow-[0_15px_35px_rgba(0,0,0,0.3)] transform rotate-6 origin-bottom z-0"
              style={{
            ...
            <div 
              className="absolute right-[22%] bottom-[120px] w-[250px] h-[340px] rounded-t-[125px] shadow-[0_12px_30px_rgba(0,0,0,0.25)] border border-white/[0.06] transform -rotate-3 origin-bottom z-10"
              style={{
            ...
            <div className="absolute right-[15%] bottom-[230px] w-[150px] h-[280px] z-20 pointer-events-none anim-sway">
            ...
            <div className="absolute right-[8%] bottom-[80px] w-[340px] h-[100px] z-20 flex flex-col items-center justify-end pointer-events-none">
              {/* Upper Tier */}
              <div 
            ...
            <div className="absolute left-[8%] top-[10%] w-[260px] rounded-2xl glass-luxury border border-white/[0.06] p-4.5 shadow-xl anim-luxury-float z-30">
            ...
            <div className="absolute right-[5%] bottom-[130px] rounded-2xl bg-[#191a21] border border-white/[0.08] p-4 shadow-2xl anim-luxury-float-delayed z-40 text-white w-[250px]">
