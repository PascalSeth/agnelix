  ...
  const personas = [
    {
      ...
      desc: "Find dentists, roofers, and salons. Search by niche and city, send personalized emails, and let AI handle the follow-ups.",
      image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=800&auto=format&fit=crop",
      prompt: "Find 50 plumbers in Dallas without SEO...",
      tags: ["Local Search", "Personalized Outreach", "Auto Follow-Up"],
    },
    {
      id: "b2b",
      icon: Briefcase,
      title: "B2B Service Providers",
      desc: "AI checks prospect websites, writes a tailored pitch, and manages your whole pipeline from first email to booked meeting.",
    ...
    },
    {
      ...
      desc: "Working alone? Agnelix is your AI sales team. It finds businesses, handles replies, and fills your calendar while you focus on client work.",
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="anim-fade-up text-center mb-16 lg:mb-24">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-400 font-medium">
            Whether you run an agency, a service company, or work solo — Agnelix acts as your dedicated AI SDR to fill your calendar.
          </p>
        </div>
