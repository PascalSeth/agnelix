import { Shield, Lock, Activity, Workflow } from "lucide-react"
    ...
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="anim-fade-up mx-auto mt-8 max-w-2xl text-xl text-white/25" style={{ animationDelay: "0.3s" }}>
          Join technical founders and agency owners who stopped cold-calling and started closing. Your first AI campaign goes live in under 10 minutes. No credit card required.
        </p>
        ...
        <div className="anim-fade-up mt-12 flex flex-col items-center gap-8" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm text-white/20">
            {[
              { icon: Shield, text: "SOC 2 Prep" },
              { icon: Lock, text: "GDPR / CCPA" },
              { icon: Activity, text: "99.9% Uptime" },
              { icon: Workflow, text: "REST API" }
            ].map(({ icon: Icon, text }) => (
