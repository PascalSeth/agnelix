...
export default async function OnboardingLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <div className="relative h-screen flex flex-col bg-[#05060a]" style={{ backgroundColor: "#05060a", height: "100dvh", overflow: "hidden" }}>
        <DashboardBg />
        ...
        <main className="relative z-10 flex-1 flex flex-col overflow-hidden" style={{ height: "calc(100dvh - 3.5rem)" }}>
          {children}
        </main>
      </div>
    </>
