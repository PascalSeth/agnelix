...
import { GitBranch, Plus, Trash2, Loader2, Pencil, X, ChevronDown, ChevronUp, Mail, UserPlus, MessageSquare, Hourglass, Lightbulb, Wand2 } from "lucide-react"
...
export default function SequencesPage() {
  ...
  async function runAiAssist(idx: number) {
    ...
    try {
      ...
      toast.success("Guidelines generated by Galien")
    } catch (err) {
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1 space-y-3">
              ...
              <p className="text-[11px] text-white/25 leading-relaxed">
                💡 Tip: Use the <span className="text-white/45 font-semibold">Galien Step Copilot</span> on each step — describe the angle in a sentence
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-3 justify-between md:justify-end flex-wrap">
                      <div className="flex items-center gap-2">
                        ...
                        {(s.stepType === "LINKEDIN_CONNECT" || s.stepType === "LINKEDIN_MESSAGE") && (
                          <span
                            className="text-[9px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded-md bg-amber-500/10 border border-amber-500/25 text-amber-300/90"
                            title="LinkedIn has no API integration — when this step is due, the AI drafts the message and creates a copy & send task in your inbox instead of sending automatically."
                          >
                            Manual Task
                          </span>
                        )}
                    ...
                    <div className="mt-3 pt-3 border-t border-white/5 space-y-3">
                      ...
                      >
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[9px] font-black text-pink-400/80 uppercase tracking-widest">Galien Step Copilot</span>
                        </div>
                        ...
                        <div key={sIdx} className="relative space-y-1">
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {(stepType === "LINKEDIN_CONNECT" || stepType === "LINKEDIN_MESSAGE") && (
                              <span
                                className="text-[9px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded-md bg-amber-500/10 border border-amber-500/25 text-amber-300/90"
                                title="AI drafts the message and creates a copy & send task in your inbox — nothing is sent automatically on LinkedIn."
                              >
                                Manual Task
                              </span>
                            )}
